...
public class Store {
    ...
    public static void main(String[] args) {
        ...
        Cashier.setDateOfPurchase(dateOfPurchase);
        ...
        Food food1 = new Food("Breads", "Zemel", 1.26f, LocalDate.of(2021, 11, 9));
        Food food2 = new Food("Sour milk", "Elena", 1.00f, LocalDate.of(2021, 11, 15));

        Beverage beverage1 = new Beverage("water", "Bankya", 1.50f, LocalDate.of(2022, 1, 8));
        Beverage beverage2 = new Beverage("water", "Devin", 1.50f, LocalDate.of(2021, 11, 9));
